...
export function buildToolDiff(
  ...
  if (result.name === 'edit_file' && rawPath && typeof args.old_string === 'string' && typeof args.new_string === 'string') {
    ...
    if (r.insertions > 0 || r.deletions > 0) {
      ...
      return { ...result, diff: w.diff, filePath: w.filePath, insertions: w.insertions, deletions: w.deletions }
    }
