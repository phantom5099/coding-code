...
const useGlobalStore = create()(
  immer((set2) => ({
    ...
    setFileDirty: (path, isDirty) => set2((s) => {
      const f = s.files.openFiles.find((f2) => f2.path === path);
      if (f) f.isDirty = isDirty;
    }),
    setGit: (status) => set2((s) => {
      s.git = status;
    }),
    addTerminal: (session) => set2((s) => {
      s.terminals.push(session);
    }),
    removeTerminal: (id) => set2((s) => {
      s.terminals = s.terminals.filter((t) => t.id !== id);
    }),
    setCurrentThread: (id) => set2((s) => {
      s.agent.currentThreadId = id;
    }),
    upsertThread: (thread) => set2((s) => {
      s.agent.threads[thread.id] = thread;
    }),
    setApprovalPolicy: (policy) => set2((s) => {
      s.agent.approvalPolicy = policy;
    }),
    setModel: (model) => set2((s) => {
      s.agent.model = model;
    }),
    setStreaming: (v) => set2((s) => {
      s.agent.isStreaming = v;
    }),
    setCursor: (line, col) => set2((s) => {
...
function AgentLayout() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex items-center justify-center flex-col gap-6 bg-[#1e1e1e]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-semibold text-[#cccccc]", children: "Agent 模式" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#888] text-sm", children: "Phase 2 中实现完整 Agent 布局" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: () => setMode("ide"),
        className: "px-4 py-2 bg-[#0e639c] hover:bg-[#1177bb] text-white rounded text-sm transition-colors",
        children: "切换到 IDE 模式 (Ctrl+Shift+E)"
      }
    )
  ] });
}
function IDELayout() {
  const setMode = useGlobalStore((s) => s.setMode);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex items-center justify-center flex-col gap-6 bg-[#252526]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-semibold text-[#cccccc]", children: "IDE 模式" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#888] text-sm", children: "Phase 3 中实现完整 IDE 布局" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: () => setMode("agent"),
        className: "px-4 py-2 bg-[#0e639c] hover:bg-[#1177bb] text-white rounded text-sm transition-colors",
        children: "返回 Agent 模式 (Ctrl+Shift+A)"
      }
    )
  ] });
}
function App() {
  ...
  reactExports.useEffect(() => {
    ...
    window.addEventListener("menu:switchMode", ((e) => {
      setMode(e.detail);
    }));
    return () => {
      off?.();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-screen flex flex-col bg-[#1e1e1e] text-[#cccccc] overflow-hidden select-none", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: { display: mode === "agent" ? "flex" : "none" },
        className: "flex-1 flex flex-col overflow-hidden",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(AgentLayout, {})
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        className: "flex-1 flex flex-col overflow-hidden",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(IDELayout, {})
      }
    )
  ] });
}
